      ...
      <vstack width="100%" height="100%"  alignment="center middle" grow>
        {
            ...
            (live&&screen=="play")?<Play userId={userId} postId={postId} isModerator={isModerator} ui={ui} redis={redis}/>:
            (screen=="configure")?<Configure userId={userId} postId={postId} isModerator={isModerator} ui={ui} redis={redis}/>:
